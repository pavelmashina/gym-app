...
function ProfileIcon(){return <svg className="profile-icon" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.7" aria-hidden="true"><circle cx="16" cy="11" r="5"/><path d="M7 27c1.2-5.7 4.2-8.4 9-8.4s7.8 2.7 9 8.4"/></svg>}
...
export function NutritionScreen({ user, profile }){
  ...
  {tab==='recipes'&&<section className="nutrition-placeholder"><span>Рецепты</span><h1>Соберём удобную базу рецептов</h1><p>Здесь будут рецепты с КБЖУ, фильтрами и возможностью добавлять блюда в рацион.</p></section>}
