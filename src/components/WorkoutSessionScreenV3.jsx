...
function ActiveWorkout({ entry, onEntryChange, onFinish, onAbandon, onRequestReplacement, finishing, abandoning, error }) {
...
export function WorkoutSessionScreen({ scheduledWorkoutId, onBack, onCompleted, onRequestReplacement }) {
