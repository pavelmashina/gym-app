...
const PLAN_LABELS = { free: 'Тариф не подключен', pro: 'Pro', premium: 'Premium' };
...
export function AccountScreen({ user, profile, loading, onBack, onSignOut, onAccountDeleted, onProfileUpdated, onOpenSettings }) {
