...
-- `single` moves only the selected scheduled workout while keeping surrounding dates unchanged.
-- `tail` moves the selected workout and rebuilds all remaining scheduled dates using the program rhythm.
